!function (t) {
    function n(t) { t = t || window.event, t.preventDefault && t.preventDefault(), t.returnValue = !1 } function i(t) { if (r[t.keyCode]) return n(t), !1 } function e() { window.addEventListener && window.addEventListener("DOMMouseScroll", n, !1), window.onwheel = n, window.onmousewheel = document.onmousewheel = n, window.ontouchmove = n, document.onkeydown = i } function o() { window.removeEventListener && window.removeEventListener("DOMMouseScroll", n, !1), window.onmousewheel = document.onmousewheel = null, window.onwheel = null, window.ontouchmove = null, document.onkeydown = null } var a = function () {
    ...
    t.fn.sliiide = function (n) {
        function i() { u.one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", O), c.body_slide ? (u.children().css(y(b[c.place].deactivateAnimation)), a !== !1 && a <= 11 && l.css(y(A[c.place].deactivateAnimation))) : l.css(y(A[c.place].deactivateAnimation)), c.no_scroll && o(), d = !1 } var r, s, c = t.extend({ toggle: "#sliiider-toggle", exit_selector: ".slider-exit", animation_duration: "0.5s", place: "right", animation_curve: "cubic-bezier(0.54, 0.01, 0.57, 1.03)", body_slide: !0, no_scroll: !1, auto_close: !1 }, n), d = !1, l = t(this), f = t(c.toggle), m = t(c.exit_selector), u = t("body"), h = { transform: "", "overflow-x": "", transition: "", position: "" }, v = { transform: "", transition: "", width: "", height: "", left: "", top: "", bottom: "", right: "" }, p = { visibility: "hidden", transition: "transform " + c.animation_duration + " " + c.animation_curve, position: "fixed" }, w = { transition: "transform " + c.animation_duration + " " + c.animation_curve }, g = { "overflow-x": "hidden" }, x = { position: "relative", "overflow-x": "hidden" }, b = { setleft: function (t) { this.left.activateAnimation.transform = "translateX(" + t + "px)", this.left.deactivateAnimation.transform = "translateX(0px)" }, setright: function (t) { this.right.activateAnimation.transform = "translateX(-" + t + "px)", this.right.deactivateAnimation.transform = "translateX(0px)" }, setbottom: function (t) { this.bottom.activateAnimation.transform = "translateY(-" + t + "px)", this.bottom.deactivateAnimation.transform = "translateY(0px)" }, settop: function (t) { this.top.activateAnimation.transform = "translateY(" + t + "px)", this.top.deactivateAnimation.transform = "translateY(0px)" }, left: { activateAnimation: { transform: "" }, deactivateAnimation: { transform: "" } }, right: { activateAnimation: { transform: "" }, deactivateAnimation: { transform: "" } }, top: { activateAnimation: { transform: "" }, deactivateAnimation: { transform: "" } }, bottom: { activateAnimation: { transform: "" }, deactivateAnimation: { transform: "" } } }, A = {
            ...
            var e = t.offsetWidth
            return i === e && (e = n.clientWidth), document.body.removeChild(n), i - e
        }, z = function () {
            if (E(), l.css("visibility", "visible"), c.body_slide) {
                u.css(y(x)), t("html").css(g), u.children().css(y(w)), u.children().css(y(b[c.place].activateAnimation)), a !== !1 && a <= 11 && l.css(y(A[c.place].activateAnimation))
                t(window).height(), t(window).scrollTop(), l.height(), l.offset().top
            } else l.css(y(A[c.place].activateAnimation))
            c.no_scroll && e(), d = !0
        }, O = function (n) { l.css("visibility", "hidden"), u.css(h), t("html").css(h), u.unbind("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", O), k() }
